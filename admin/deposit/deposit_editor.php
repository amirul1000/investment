...
?>
<script language="javascript" src="deposit.js"></script>
	                ...
	                <table class="table">
							 <tr>
							  <td>  
								 ...
								 <form name="frm_deposit" method="post"  enctype="multipart/form-data" onSubmit="return checkRequired();">			
								  <div class="portlet-body">
						         <div class="table-responsive">	
					                <table class="table">
										 <tr>
...
<select  name="investment_id" id="investment_id"   class="textbox">
	...
	?> 
						 ...
						 <td>Date Deposit</td>
						 <td>
						    <input type="text" name="date_deposit" id="date_deposit"  value="<?=$date_deposit?>" class="textbox">
							<a href="javascript:void(0);" onclick="displayDatePicker('date_deposit');"><img src="../../images/calendar.gif" width="16" height="16" border="0" /></a>
						 </td>
				     </tr>
										 <tr> 
											 <td align="right"></td>
