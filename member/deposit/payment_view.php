           ...
           <div class="portlet-title">
            ...
            <div class="portlet-body">
	         <div class="table-responsive">	
                ...
                <?php
				    $_SESSION['minimum_amount'] = $_REQUEST['minimum_amount'];
					$_SESSION['investment_id']  = $_REQUEST['investment_id'];
					//session_unset();
					...
					<br><br>
					<form method="POST" action="" name="perform">
					...
					<table width="600" border="0">
						...
						<tr>
							...
							<td align=left><br><input type=text size=4 maxlength=7 name=amount value="<?=$_SESSION['minimum_amount']?>"> USD</td>
						</tr>
                        <!--
						<tr>
						...
						<tr>
							<td/>
							<td>
                            <input type="hidden" name="cmd" value="perform">
